...
process(open(os.path.join(THIS_FOLDER, "last/out.txt"), "rb"))
process(open(os.path.join(THIS_FOLDER, "last/bak1.txt"), "rb"))
process(open(os.path.join(THIS_FOLDER, "last/bak2.txt"), "rb"))
